...
from .views import VenuePreRegisterView, VenueByExecutiveView, CourtCreateView, VenueCourtsView, VenueSlotGenerationView, VenueStatusUpdateView, VenueListView, VenueDetailView
...
urlpatterns = [
    ...
    path('<int:venue_id>/', VenueDetailView.as_view(), name='venue-detail'),
]
